...
- The coordinator (`@fee-bleed-coordinator`) is the workflow entrypoint. It orchestrates subagent handoffs and maintains `DOCS/FEE_BLEED_CURRENT_PHASE.md` as the phase tracker.
